...
import { setAiringToday, setAiringToday300, setBannerData, setImageURL, setMovies300, setNowPlaying, setNowPlaying300, setOnTheAir, setOnTheAir300, setPopular300, setTopRated, setTopRated300, setTrendingData, setTvShows300, setUpcomingData, setUpcomingData300 } from '../store/slices/movieSlice';
  ...
  useEffect(() => {
    const fetchAllMovieData = async () => {
      try {
        ...
        const [trendingWeek, trendingDay, config, upcoming, nowPlaying, topRated, onTheAir, airingToday, nowPlaying300, topRated300, onTheAir300, airingToday300, upcoming300, tvShows300, movies300, popular300] = await Promise.all([
