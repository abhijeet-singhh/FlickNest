...
const NewSection = () => {
    const NewData = useSelector((state: RootState) => state.movieData.new300 ?? []) as MovieData[]
    ...
    return (
        <div className="mt-3 md:mt-10 mx-2 md:mx-5">
            <div className="flex items-end justify-between">
                ...
                <p onClick={() => navigate('/')} className="flex items-center gap-1 text-[14px] text-zinc-400 mr-3 cursor-pointer">View more <MdKeyboardArrowRight size={16} /></p>
            </div>
